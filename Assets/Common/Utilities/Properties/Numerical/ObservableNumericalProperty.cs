...
{
    /// <summary>
    /// A wrapper for <see cref="Utilities.Properties.Numerical.NumericalProperty{TNumerical, TContext, TModifierReader}"/>
    ...
    /// <see cref="Utilities.Properties.Numerical.NumericalProperty{TNumerical, TContext, TModifierReader}"/> class instance.
